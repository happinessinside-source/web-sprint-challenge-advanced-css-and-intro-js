...
"the artist at index 0 is Amedio Modigliani"

//(2) Bio of the third artist (2nd index) in the array 

let correct = artists.findIndex(item {
    if (bio = 2) return true;
});
...
artists.[19]
const getArtistByIndex {
    artistMethod: function() {
        console.log('the artist at index {19} is {Albrecht Durer'
        });
};
};
...
const the20s {
    'numbre': 'Salvador Dali',
    'numbre': 'Frida Kahlo'
    getTwenties: function(artist) {
        console.log(person.numbre[i]);
    },
};
